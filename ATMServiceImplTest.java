...
class ATMServiceImplTest {
    ...
    @Test
    @DisplayName("checkBalance on the ATM Service invokes accountService's checkBalance")
    ...
    @Test
    @DisplayName("ATM Service throws an exception if the amount is less than 20")
    void testWithdrawAmount_LessThan20() {
    	// when
    ...
    @Test
    @DisplayName("ATM Service throws an exception if the amount is more than 250")
    void testWithdrawAmount_GreaterThan250() {
        //when
        Throwable throwable = assertThrows(IllegalArgumentException.class,
    ...
    @Test
    @DisplayName("ATM Service throws an exception if the underlying accountService throws one")
    void testATMService_ThrowsException_ifAccountService_throwsAnException() {
    ...
    void testATMService_returns_right_notes_for_100() {
    ...
    void testATMService_returns_right_notes_for_50() {
    ...
    void testATMService_returns_right_notes_for_25() {
    ...
    void testATMService_returns_right_notes_for_30() {
        atmService.getBankNotes().put(5, 1);
        // given
        Integer amount = 30;
        int accountId = 1001;
    ...
    void testATMService_returns_exception_for_23() {
